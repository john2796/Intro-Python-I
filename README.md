...
[x] It's time to learn a new language! Python!

[x] Python is a popular, easy-to-use programming language that has significant
traction in the field.

[x]Remember the goal is _learning to learn_, so keep track of what works for you
...
[x] Each directory inside the `src/` directory presents exercises revolving around a
